...
// this filters it to the search and clears the search area after you search
function clear(){
    gallery.innerHTML = "";
    searchInput.value = "";
}
...
async function loadMore(){
    page++;
    if(currentSearch){
        fetchLink = `https://api.pexels.com/v1/search?query=${currentSearch}+query&per_page15&page=${page}`    
    }else{
